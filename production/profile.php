                ...
                <div class="x_panel">
                 ...
                 <div class="x_content">
                    ...
                    <p>Input your problem here.</p>
                       <form class="form-horizontal form-label-left" action="profile.php" method="post" name="take">
...
$result = mysqli_query($connection, "UPDATE konsumen SET nama = '$nama', alamat = '$alamat', email = '$email', no_telp = '$no_telp', password='$password', foto = '$foto'  WHERE id = '$id_konsumen'")or die(mysql_error());
if($result){
  echo 'suksees';
}
