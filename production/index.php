            ...
            <div class="col-md-14 col-sm-14 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 1%; padding-right: 1%; text-align: justify;">
                  <p>Welcome to my engineer dashboard, here you can do anything, because any services that you need it's all here. If you had a problem, just come here and you will get the solution only in a moment. Input your problem data in your form, wait until your engineer take your job, and meet up your engineer. You can also negotiate with your engineer about the cost of services. We have standard prices of services, so if our engineer give you the price that out of standard, please report to us. <i class="fa fa-smile-o"></i></p>
                </div>
                </div>
              </div>
