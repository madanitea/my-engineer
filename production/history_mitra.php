<?php 
  ...
  $nama = $cek['nama'];
  $foto = $cek['foto'];
  $read = "select * from data_service where mitra_id='$id' and status='finished'";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>History of <small><?php echo $nama ?></small></h2>
                    ...
                    <p class="text-muted font-13 m-b-30">
                      This data is your data. it is like your medical record.
                    </p>
